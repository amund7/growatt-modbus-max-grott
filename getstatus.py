    ...
    def read(self):
        ...
        info = {
            ...
            "values": {
              ...
              "pvtemperature": (row.registers[93] ^ 0x8000) - 0x8000,
              "pvipmtemperature": (row.registers[94] ^ 0x8000) - 0x8000,
              "pvboosttemp": (row.registers[95] ^ 0x8000) - 0x8000,
              "temp4": (row.registers[96] ^ 0x8000) - 0x8000,
              "bat_dsp": (row.registers[97] ^ 0x8000) - 0x8000,
